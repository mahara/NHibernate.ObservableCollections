...
FOR %%G IN (%BUILD_PARAMETERS%) DO (
    FOR /F "tokens=1,2,3 delims=|" %%H IN (%%G) DO (
        ...
        dotnet build "!BUILD_PARAMETER___PROJECT_FILE_PATH!" --property:PACKAGE_VERSION=!BUILD_PARAMETER___VERSION! --configuration !BUILD_PARAMETER___CONFIGURATION! || EXIT /B 4
    )
)
