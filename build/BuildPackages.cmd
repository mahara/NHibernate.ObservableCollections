...
IF NOT DEFINED ARTIFACTS_FOLDER_PATH (
    ECHO Artifacts folder path must be defined.
    ECHO.
    EXIT /B 1
)
...
FOR %%G IN (%BUILD_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        IF NOT DEFINED BUILD_PARAMETER___INPUT_FILE_PATH (
        ...
        IF /I "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            IF NOT DEFINED BUILD_PARAMETER___FRAMEWORKS (
                ECHO Skipping build operations for build input file "!BUILD_PARAMETER___INPUT_FILE_NAME!" because no defined frameworks match "!PARAMETER___FRAMEWORKS!".
...
FOR %%G IN (%TEST_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        IF /I NOT "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            IF NOT DEFINED TEST_PARAMETER___FRAMEWORKS (
                ECHO Skipping test operations for test input file "!TEST_PARAMETER___INPUT_FILE_NAME!" because no defined frameworks match "!PARAMETER___FRAMEWORKS!".
        ...
        IF /I "!TEST_PARAMETER___SKIP_TEST_OPERATION!" == "false" (
            FOR %%J IN (!TEST_PARAMETER___FRAMEWORKS!) DO (
                ...
                IF NOT DEFINED TEST_PARAMETER___INPUT_FILE_PATH (
...
FOR %%G IN (%PACKAGE_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        SET "PACKAGE_PARAMETER___FRAMEWORKS=%%I"
        ...
        IF NOT DEFINED PACKAGE_PARAMETER___FRAMEWORKS (
        ...
        IF NOT DEFINED PACKAGE_PARAMETER___INPUT_FILE_PATH (
        ...
        IF /I "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            CALL :RESOLVE_FRAMEWORKS "!PACKAGE_PARAMETER___FRAMEWORKS!" "!PARAMETER___FRAMEWORKS!" PACKAGE_PARAMETER___FRAMEWORKS

            IF NOT DEFINED PACKAGE_PARAMETER___FRAMEWORKS (
                ECHO Skipping package operations for package input file "!PACKAGE_PARAMETER___INPUT_FILE_NAME!" because no defined frameworks match "!PARAMETER___FRAMEWORKS!".
...
FOR %%G IN (%PACKAGE_NEV_PARAMETERS%) DO (
    ...
    ECHO   ----------------------------------------------------------------------------------------------
    ECHO   Updating package dependency versions for packages with package ID prefix "!PACKAGE_NEV_PARAMETER___DEPENDENCY_PACKAGE_ID_PREFIX_FILTER!" ^(!PARAMETER___VERSION! ^| !PARAMETER___CONFIGURATION!^)^.^.^.
    ECHO   ----------------------------------------------------------------------------------------------
