...
dotnet build "NHibernate.ObservableCollections-All.sln" --configuration %BUILD_CONFIGURATION% --property:BUILD_VERSION=%BUILD_VERSION% || EXIT /B 1
...
dotnet test "bin\%BUILD_CONFIGURATION%\net48\NHibernate.ObservableCollections.Tests\NHibernate.ObservableCollections.Tests.dll" --results-directory "bin\%BUILD_CONFIGURATION%" --logger "nunit;LogFileName=NHibernate.ObservableCollections.Tests-NetFramework-TestResults.xml;format=nunit3"
