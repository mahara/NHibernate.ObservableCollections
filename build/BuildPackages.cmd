...
REM 4  = Build input file path is not defined, or file path resolution failed.
REM 5  = Build framework is not defined, or framework selection failed.
REM 6  = dotnet build failed.
REM 7  = Test input file path is not defined, or file path resolution failed.
REM 8  = Test framework is not defined, or framework selection failed.
REM 9  = dotnet test failed.
REM 10 = Package input file path is not defined, or file path resolution failed.
REM 11 = Package framework is not defined, or framework selection failed.
...
FOR %%G IN (%BUILD_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        IF /I "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            IF ERRORLEVEL 1 (
                ECHO Build input file "!BUILD_PARAMETER___INPUT_FILE_NAME!" does not define any frameworks that match the requested frameworks: "!PARAMETER___FRAMEWORKS!".
                EXIT /B 5
            )
...
FOR %%G IN (%TEST_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        IF /I NOT "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            IF ERRORLEVEL 1 (
                ECHO Test input file "!TEST_PARAMETER___INPUT_FILE_NAME!" does not define any frameworks that match the requested frameworks: "!PARAMETER___FRAMEWORKS!".
                EXIT /B 8
            )
        )
...
FOR %%G IN (%PACKAGE_PARAMETERS%) DO (
    FOR /F "tokens=1,2 delims=|" %%H IN (%%G) DO (
        ...
        IF /I "!PARAMETER___FRAMEWORKS!" == "!PARAMETER___FRAMEWORKS___DEFAULT!" (
            ...
            CALL :SELECT_FRAMEWORKS "!PACKAGE_PARAMETER___FRAMEWORK!" "!PARAMETER___FRAMEWORKS!" PACKAGE_PARAMETER___FRAMEWORKS
            IF ERRORLEVEL 1 (
                ECHO Package input file "!PACKAGE_PARAMETER___INPUT_FILE_NAME!" does not define any frameworks that match the requested frameworks: "!PARAMETER___FRAMEWORKS!".
                EXIT /B 11
            )
...
dotnet build "!WORKSPACE_FOLDER_PATH!\tools\Explicit.NuGet.Versions\Explicit.NuGet.Versions.slnx" --configuration Release >NUL || EXIT /B 13
