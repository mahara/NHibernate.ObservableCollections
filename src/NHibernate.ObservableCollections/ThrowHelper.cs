...
namespace Iesi.Collections.Generic
{
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException(Environment.GetResourceString("Arg_WrongType", key, targetType), nameof(key));
        }

        internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
        {
            throw new ArgumentException(Environment.GetResourceString("Arg_WrongType", value, targetType), nameof(value));
        }
        ...
        internal static string GetResourceName(ExceptionResource resource)
        {
            ...
            switch (resource)
            {
                ...
                case ExceptionResource.Serialization_InvalidOnDeserialization:
                    resourceName = "Serialization_InvalidOnDeserialization";
                    break;
    ...
    internal enum ExceptionResource
    {
        ...
        Serialization_InvalidOnDeserialization,
    ...
    internal class Environment
    {
        internal static string GetResourceString(string key)
        {
            ...
            {
                case "Arg_WrongType":
                    message = @"Arg_WrongType=The value ""{0}"" isn't of type ""{1}"" and can't be used in this generic collection.";

                    break;

                case "ArgumentOutOfRange_Index":
                    message = "Index was out of range. Must be non-negative and less than the size of the collection.";

                    break;

                case "NotSupported_ReadOnlyCollection":
                    message = "Collection is read-only.";

                    break;

                default:
                    Contract.Assert(false, $@"The key ""{key}"" is not defined.");
