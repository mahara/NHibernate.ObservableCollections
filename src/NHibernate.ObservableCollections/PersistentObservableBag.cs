namespace NHibernate.Collection.Generic
{
    ...
    public class PersistentObservableBag<T> : PersistentGenericBag<T>, INotifyCollectionChanged
    {
            ...
            : base(session, coll)
        {
            if (coll != null)
            {
                ((INotifyCollectionChanged) coll).CollectionChanged += this.OnCollectionChanged;
            }
        }
        ...
        public override void BeforeInitialize(ICollectionPersister persister, int anticipatedSize)
        {
            ...
            ((INotifyCollectionChanged) this.InternalBag).CollectionChanged += this.OnCollectionChanged;
        }
