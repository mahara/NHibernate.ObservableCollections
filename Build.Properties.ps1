...
$BUILD_UNIT_PARAMETERS = @{
    'Iesi.ObservableCollections' = @{
        ...
        # does not have dependencies on packages whose IDs start with "Iesi.ObservableCollections".
    ...
    'NHibernate.ObservableCollections' = @{
        ...
        # has dependencies on packages whose IDs start with "Iesi.ObservableCollections".
        PACKAGE_NEV_PARAMETERS = @(
            'Iesi.ObservableCollections'
        )
    }
